...
1 until 101
:quit
List(1,2,3,4) - List(4,2)
List(1,2,3,4) :- 2
val g = (x:Int, y:Int, z:Int) => x + y + z
g.curried
Function.uncurried(res2)
g(4, _:Int, 10)
g(4)
res4(4)
val a = 1 to 10
val b = 1 until 10
val b = 1 until 10 step 10
List(1 to 10)
Some(14)
Some(Some(14).get + 2)
Some(14).map(2+)
...
Arrays.asList(1,2,3,4,5).stream().map(x -> x + 1).toCollector(Collectors.toList());
run
:quit
(1 to 100).take(5)
:quit
Map(("San Francisco", "Giants"), ("Los Angeles", "Dodgers"), ("Texas", "Rangers"))
res0 + (1 -> 40)
res0 + ("1" -> 40)
res0
res0 + ("San Francisco", "Dodgers")
res0
res0 + ("San Francisco", "Dodgers")
res0 + ("San Francisco" -> "Dodgers")
res0 + ("San Francisco", "Dodgers")
...
mutable += (90.0 -> "Ninety")
mutableMap += (90.0 -> "Ninety")
mutableMap += (90.0 -> 2000)
mutableMap += (90 -> 2000)
val myMapTheWayIWantIt:Map[Any,Any] = Map(1->"One", 2->"Two")
myMapTheWayIWantIt + ("Pinapple Pizza" -> 200.00)
val myMapTheWayIWantIt = Map(1->"One", 2->"Two"):Map[Any, Any]
val myMapTheWayIWantIt = Map(1->"One", 2->"Two")
myMapTheWayIWantIt + ("1", "4412")
myMapTheWayIWantIt + ("1" -> "4412")
:quit
0 +: List(1,2,3,4,5)
0 +: List(1,2,3,4,5) :+ 6
...
new BigInteger(6.toString)
:quit
List().get(0)
List():List[String].get(0)
List():List[String](0)
val lst = List()
...
lst.apply(0)
:quit
def stuff(x:Int) = Stream.cons(x, stuff(x + 1))
def stuff(x:Int):Stream[Int] = Stream.cons(x, stuff(x + 1))
stuff(1)
stuff(1).take(10)
stuff(1).take(10).mkString(",")
stuff(1).take(10).toList
def stuff(x:Int):Stream[Int] = x #:: stuff(x + 1)
Source.fromUrl("http://www.microsoft.com").take(1000).mkString
scala.io.Source.fromUrl("http://www.microsoft.com").take(1000).mkString
scala.io.Source.fromURL("http://www.microsoft.com").take(1000).mkString
val fibs(x:Int):Stream[Int] = 1 #:: 1#:: fibs.zip(fib.tail).map{n => n._1 + n._2}
lazy val fibs:Stream[Int] = 1 #:: 1#:: fibs.zip(fib.tDail).map{n => n._1 + n._2}
lazy val fibs:Stream[Int] = 1 #:: 1#:: fibs.zip(fib.tail).map{n => n._1 + n._2}
lazy val fibs:Stream[Int] = 1 #:: 1#:: fibs.zip(fibs.tail).map{n => n._1 + n._2}
fibs.take(10).mkString(",
fibs.take(10).mkString(",")
scala.io.Source.fromURL("http://www.microsoft.com").take(1000).mkString
:quit
val g = new Employee("Bob", "Simpson")
import com.evolutionnext.testscala
val g = new Employee("Bob", "Simpson")
import com.evolutionnext.testscala._
val g = new Employee("Bob", "Simpson")
:quit
"ls".!!
...
"ls -a" #| "grep xml\" !!
"ls -a" #| "grep xml" !!
val result = "ls -a" #| "grep xml" !!
result
val result = "ls -a" #| "grep xml" !!
Seq("find", "/home/danno", "-name", "*.scala", "-type", "f")
res16!
:quit
val a = 10
a = 15
...
:quit
val e = new Employee("Bob", "X")
import com.xyzcorp.employee.Employee
val e = new Employee("Bob", "X")
e.firstName
:quit
3 + 4
...
foo(10)
val emptyList = Nil
val emptyList = Nil:List[Int]
foo(10)
 ("one", 1, 1.0, "Foo", 'c')
 ("one", 1, 1.0, "Foo", 'canoodlew')
 ("one", 1, 1.0, "Foo is here!", 'c')
val z = (x:Int, y:Int) => x + y + 100
val z:(Int, Int) => Int = (x:Int, y:Int) => x + y + 100
val z:Function2[Int, Int, Int] = (x:Int, y:Int) => x + y + 100
val z:(Int, Int) => Unit = (x:Int, y:Int) => println(x + y)
z(10, 18)
val z:(Int, Int) => Int = (x:Int, y:Int) => x + y + 100
z(10, 18)
val z:(Int, Int) => Unit = (x:Int, y:Int) => x * 10
z(10, 34)
:paste
def returningFunctions(x:Int):(Int => Int) = {
  return (y:Int) => 19 + y + x
}
returningFunctions(4)
returningFunctions(10)
returningFunctions(70)
res13(3)
...
val e = new Employee("Jane")
e.lastName
class Employee(firstName:String, lastName:String) {
}
val e = new Employee("Sam", "Rogers")
class Employee(firstName:String, lastName:String) {
